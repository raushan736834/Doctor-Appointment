...
const Sidebar = ({ closeSidebar, onLogoutClick }) => {
  ...
  return (
    <div className="flex flex-col h-screen bg-gray-200 text-gray-900 md:w-48 lg:w-64">
      <div className="flex flex-col ml-2 md:justify-between justify-start h-full items-start text-start lg:items-center md:items-center">
        ...
        <div
          ...
          role="button"
          tabIndex={0}
          className="mb-4 md:mb-5 flex justify-center md:justify-center items-center p-2 font-semibold hover:bg-gray-800 hover:text-white transition duration-300 ease-in-out rounded-lg cursor-pointer w-full"
        >
