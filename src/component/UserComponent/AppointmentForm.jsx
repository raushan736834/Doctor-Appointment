  ...
  <div>
    ...
    <div className="flex flex-wrap gap-3 justify-center">
      {availableSlots.length > 0 ? (
        availableSlots.map((slot) => (
          <button
            ...
            className={`px-4 py-2 rounded-full border transition duration-200 text-sm
              ${selectedSlot === slot ? "bg-blue-600 text-white border-blue-600" : "bg-white text-gray-700 border-gray-300 hover:bg-blue-100"}
            `}
          >
            {slot}
          </button>
        ...
        <p className="text-center text-gray-500">No available slots for this period.</p>
      )}
    </div>
  </div>
);
