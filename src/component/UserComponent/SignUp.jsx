    ...
    <>
      ...
      >
        {({ isValid, isSubmitting }) => (
          <>
            <div className="blur-0 sm:blur-4 bg-white/90 sm:bg-white/60 rounded-2xl sm:rounded-3xl shadow-lg sm:shadow-2xl p-4 sm:p-8">
              {loading && (
                <div className="fixed inset-0 bg-white/60 flex justify-center items-center z-[9999]">
                  <Spinner size="xl" />
